...
var getReposUrl = function getReposUrl(company) {
  return "/orgs/".concat(company, "/repos");
};

exports.getReposUrl = getReposUrl;

var fetchRepos = function fetchRepos() {
  return _superagent.default.get("".concat(ROOT_URL).concat(getReposUrl('facebook'))).then(function (response) {
    return response.body.map(function (repo) {
      return repo.name;
    });
  });
};

var _default = fetchRepos;
exports.default = _default;
},{"superagent":"node_modules/superagent/lib/client.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _github = _interopRequireWildcard(require("~/src/github"));
...
console.log(_github.ROOT_URL);
(0, _github.default)().then(function (repos) {
  return console.log(repos);
});
},{"~/src/github":"src/github.js"}],"../../../../../usr/local/share/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/think.e31bb0bc.js.map